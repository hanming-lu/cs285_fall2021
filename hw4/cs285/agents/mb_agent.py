...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            idx_l = np.random.choice(num_data, num_data_per_ens, replace=False)

            observations = ob_no[idx_l] # DONE(Q1)
            actions = ac_na[idx_l] # DONE(Q1)
            next_observations = next_ob_no[idx_l] # DONE(Q1)

...
class AWACAgent(DQNAgent):
    ...
    def estimate_advantage(self, ob_no, ac_na, re_n, next_ob_no, terminal_n, n_actions=10):
        ...
        vals = []
        # DONE? Calculate Value Function Estimate given current observation
        ...
        # DONE: Calculate Q-Values
        q_vals, qa_vals = self.get_qvals(self.exploration_critic, ob_no, ac_na)
        v_pi = torch.mean(qa_vals, dim=1)

        # DONE: Calculate the Advantage
        adv = q_vals - v_pi      
        return adv
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        if (self.t > self.learning_starts
            ...
            # DONE: Update Critics And Exploration Model #
